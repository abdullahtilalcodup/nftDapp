...
//   }
 ...
 function whitelistUsersO(address[] calldata _user) public onlyOwner {
  ...
  function setWhitelistStartTime(uint start) public onlyOwner {
   
    whitelistStartTime=start;
  }
  function setWhitelistEndTime(uint end) public onlyOwner {
    whitelistEndTime=end;
  }
